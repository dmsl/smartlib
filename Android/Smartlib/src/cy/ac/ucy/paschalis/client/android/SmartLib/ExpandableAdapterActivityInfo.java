...
public class ExpandableAdapterActivityInfo extends BaseExpandableListAdapter {
	...
	ArrayList<ArrayList<DataClassActivities>>	allData;
	...
	public ExpandableAdapterActivityInfo(Context cm, ArrayList<String> gp,
			ArrayList<ArrayList<DataClassActivities>> ce) {
		context = cm;
		groupElements = gp;
		allData = ce;
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		DataClassActivities activityData = (DataClassActivities)
	...
	@Override
	public ArrayList<DataClassActivities> getGroup(int groupPosition) {
	...
	public static void setStatusString(int ack, TextView acknowledge, TextView acknowledgeTitle){
		...
		if(ack==DataClassActivities.NO_ACKS){
