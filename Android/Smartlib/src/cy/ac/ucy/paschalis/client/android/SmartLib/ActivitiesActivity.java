...
import cy.ac.ucy.paschalis.client.android.SmartLib.MainActivity.DataClassActivities;
import cy.ac.ucy.paschalis.client.android.SmartLib.MainActivity.DataClassActivities.ActivityType;
...
public class ActivitiesActivity extends SherlockActivity {
	...
	ArrayList<ArrayList<DataClassActivities>>	arrayListAllData;

	// Activity Arrays
	ArrayList<DataClassActivities>			arrayListIncomingRequests;

	ArrayList<DataClassActivities>			arrayListOutgoingRequests;

	ArrayList<DataClassActivities>			arrayListBooksIGave;

	ArrayList<DataClassActivities>			arrayListBooksITook;

	ArrayList<String>						arrayListgroupCategories;

	DataClassActivities						selectedActivity;
	...
	protected void onResume() {
		...
		arrayListAllData = new ArrayList<ArrayList<DataClassActivities>>();
				...
				case App.GENERAL_SUCCESSFULL:
					...
					for (int i = 1; i < result.length(); i++){
						...
						try{
							...
							DataClassActivities data = new DataClassActivities();
