...
import mp.paschalis.Cache.ImageLoader;
...
public class RequestActivity extends SherlockActivity {
	...
	MainActivity.DataClassActivities dataClassActivities;
	...
	private class AsyncTaskLentABook_Activities extends
			AsyncTask<LentBookActivity.DataClassLentABook, Integer, Integer> {

		LentBookActivity.DataClassLentABook mData;
		...
		@Override
		protected Integer doInBackground(LentBookActivity.DataClassLentABook... data) {
