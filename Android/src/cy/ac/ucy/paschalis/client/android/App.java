...
public class App extends Application {
	...
	static final String TAG = App.class
			.getSimpleName();
    ...
    private static final String MASTER_URL = "http://www.thechristou.com/smartLib";
	...
	public static final String noCoverURL = "images/nocover.png";

	public static boolean torchState = false;

	public static String[] entries = new String[2];

	public static String[] strValues = new String[]{
			"en", "el"};
