...
<!--    If user is logged in-->
		...
		<ul>
			...
			<header>	
				<h1><?php echo $_SESSION['REGname']?>, you have successfully registered!</h1>
			</header>
			<p>
            
                                        <h4blue>Please check your email, and activate your account!</h4blue>

								<form id="register-form" action="scripts/activateAccount.php" method="post"
									...
									<fieldset>
                                       ...
                                       <span class="p4Blue"><?php echo $_SESSION['REGtelephone']?></br></span>
                                        ...
                                        <label><span class="h4blueInline">Activation Code:&nbsp;&nbsp;</span>
                                        <input name="activationCode" type="text" />
                                        </label>
                                        
   
           
                                              <br><br>
											<a class="button" href="#" style="text-align:left"
                                        ...
                                        <?php
										if($_SESSION['actMessage']!=""){
											
											echo "<span class=\"p4Error\">Activation Error:</br><strong>";
											
											echo $_SESSION['actMessage'];
