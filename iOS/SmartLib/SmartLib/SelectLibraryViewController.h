 ...
 *
 *  @file SelectLibraryViewController.h
...
@interface SelectLibraryViewController : UITableViewController <UISearchBarDelegate,UIAlertViewDelegate,UIActionSheetDelegate>
{
